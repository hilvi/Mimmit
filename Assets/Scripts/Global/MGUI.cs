...
public static class MGUI {
	...
	public static bool HoveredButton(Rect pos, Texture image) {
		...
		{
			rect = new Rect(pos.x - pos.width * (hoverButtonSizeIncrease - 1) / 2f, 
				pos.y - pos.height * (hoverButtonSizeIncrease - 1) / 2f, pos.width * hoverButtonSizeIncrease , pos.height * hoverButtonSizeIncrease);
		}
